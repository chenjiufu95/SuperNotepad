 ...
 */
public class TestFrag03 extends BaseFragment {
    private ExampleActivity parent;

    @Override
    protected void HandleFragmentVisible(boolean visible) {
        super.HandleFragmentVisible(visible);
        if (parent != null) { parent.AddTestLog("测试_03 ==》" + (visible ? "显示" : "隐藏")); }
    }

    @Override
    protected Object setLayout() { return R.layout.frag_test_03; }
